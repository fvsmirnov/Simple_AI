...
public class BaseBrain : MonoBehaviour
{
    ...
    private void PlayerControll()
    {
        ...
        Vector3 movement = Vector3.forward * vertical * speed * Time.deltaTime;
        transform.Translate(movement);
        transform.Rotate(Vector3.up * horizontal * 50f * Time.deltaTime);

        animator.SetFloat("MoveSpeed", movement.z * 20); //value amplifier
    }
}